...
The first thing you want to do with this repo is quite likely [**fork it**] (https://github.com/articles/fork-a-repo/).  Use the Fork button in the top-right section of the page to do this.

Once you’re on your fork, you can experiment however you like with it, play with 
[branches] (https://help.github.com/articles/), issues, milestones, labels, the wiki, and more.
